...
import (
	...
	"github.com/SantiagoBedoya/delivery-app-vendors/repositories/postgres"
	"github.com/SantiagoBedoya/delivery-app-vendors/utils/ratelimit"
...
func main() {
	...
	app.Use(cors.Default())
	{
		...
		service := vendors.NewService(repository, privateKey, publicKey)
		handler := vendors.NewHandler(service)
